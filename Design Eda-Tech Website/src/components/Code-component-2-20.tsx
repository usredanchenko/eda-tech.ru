  ...
  return (
    <section id="portfolio" className="py-24 bg-gradient-to-b from-gray-900 to-black">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
          {projects.map((project, index) => {
            ...
            return (
              ...
              >
                <Card className="bg-gray-900/80 border-gray-700/50 backdrop-blur-sm overflow-hidden h-full transform-gpu transition-all duration-500 group-hover:shadow-2xl group-hover:shadow-purple-500/20">
                  {/* Project Image */}
                    ...
                    <div className="flex gap-3">
                      {project.link && (
                        <motion.button
                          ...
                          whileTap={{ scale: 0.95 }}
                          className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-600 to-cyan-600 text-white rounded-lg hover:from-purple-700 hover:to-cyan-700 transition-all"
                        >
                      ...
                      <motion.button
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        className="px-4 py-2 border border-gray-600 text-gray-400 rounded-lg hover:border-purple-500 hover:text-purple-400 transition-all"
                      >
        ...
        >
          <p className="text-gray-400 ">Want to see more of our work?</p>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
